...
public class MasterController {
    ...
    void showListAutor(ActionEvent event) {
        limparBotoes(event.getSource());
        ListAutorController controller = (ListAutorController) showFXMLFile("ListAutor.fxml");
        controller.setMasterController(this);        
    }
    ...
    @FXML
    void showAuditoria(ActionEvent event) {
        limparBotoes(event.getSource());
        showFXMLFile("ListAuditoria.fxml");
    }

    @FXML
    void showCadLivro(ActionEvent event) {
        limparBotoes(event.getSource());
        CadLivroController controller = (CadLivroController) showFXMLFile("CadLivro.fxml");
        controller.setMasterController(this);
